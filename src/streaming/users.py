...
class User:
    def __init__(self, user_id, name: str, age: int) -> None :
    ...
    def total_listening_seconds(self) -> int:
        return sum(i.duration_seconds for i in self.sessions)
...
class PremiumUser(User):
    def __init__(self, user_id, name: str, age: int, subscription_start: date) -> None :
        super().__init__(user_id, name, age)
...
class FamilyMember(User):
    def __init__(self, user_id: str, name: str, age: int, parent: FamilyAccountUser | None = None):
        super().__init__(user_id, name, age)
        self.parent = parent
